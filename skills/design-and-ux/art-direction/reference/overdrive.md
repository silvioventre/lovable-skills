...
2. **Stop and present these directions in chat, then get the user's pick before writing any code.** Explain trade-offs (browser support, performance cost, complexity).
